        ...
        <div className="flex flex-col h-full">
          ...
          {!isCollapsed && (
            <div className="px-4 py-3 border-b border-slate-800/30">
              <button className="flex items-center gap-2 w-full px-3 py-2 rounded-lg bg-slate-800/50 border border-slate-700/50 text-slate-400 hover:text-slate-300 hover:border-slate-600/50 transition-all">
      ...
      <div className={clsx(
        ...
        <header className="lg:hidden sticky top-0 z-30 bg-slate-900/95 backdrop-blur-xl border-b border-slate-800/50">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <div className="flex items-center gap-2">
              <button className="p-2 rounded-lg bg-slate-800/50 text-slate-400">
                <Search className="w-4 h-4" />
              </button>
